...
def main():
    ...
    # Creates the paths for both files
    # O_OBrien_Retention2
    #OwenO_Raw_Data_Report_all_through 10_9_20
    rPath = '/Users/bautijon/Desktop/FRED/Test_Report.xlsx'
    iPath = '/Users/bautijon/Desktop/FRED/Owen_Inactive_List_10_14_20.xlsx'
...
# Function that filters out all the group therapy patients and non appointment rows in the paitent dataframe
def filter_DF(DF):
    ###DF['Full Name'] = DF['First Name'].str.cat(DF['Last Name'],sep=" ")

    # Asks for input from the user to see what yearly statistics they want to see
    year_needed = int(input("(Type 0 for all time) What year statistics do you want: "))
    ...
    countAttendance(Therapy_Sessions, Inactive_Clients)
...
def countAttendance(Therapy, Inactive):
    ...
    RangesTotals(Dict_Values, Dict2_Values)
...
#---------------------------------------------------------------
    ...
    create_Excel(Dict1, Range_Vals2, Range_Val_Percents2, Dict2)
